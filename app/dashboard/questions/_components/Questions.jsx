        ...
        <div className='pb-20'>
            {Questions.map((question, idx) => (
                <Collapsible key={idx} className='mt-10 border-4 rounded-lg'>
                    <CollapsibleTrigger className='p-2 w-full bg-secondary flex gap-3 justify-between items-center rounded-lg my-2 text-justify'>{question.question} <ChevronsUpDown className='h-5 w-5' /> </CollapsibleTrigger>
                    <CollapsibleContent>
